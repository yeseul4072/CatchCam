...
class DroneManager(metaclass=Singleton):
    def __init__(self, host_ip='192.168.10.3', host_port=8889,
        ...
        self._is_enable_ball_detect = False
    ...
    def enable_ball_detect(self):
        self._is_enable_ball_detect = True

    def disable_ball_detect(self):
        self._is_enable_ball_detect = False
        ...
        for frame in self.video_binary_generator():
            if self._is_enable_face_detect: 
                ...
                for (x, y, w, h) in faces:
                    ...
                    break
            ############################## Ball tracking ###########################
            elif self._is_enable_ball_detect:         
                pass
