...
def command():
    ...
    if cmd == 'coordinate':
        x_coor = request.form.get('x_coor')
        y_coor = request.form.get('y_coor')
        logger.info({'action': 'command', 'cmd': cmd, 'x_coor': x_coor, 'y_coor': y_coor})
        drone.init_coordinate(x_coor, y_coor)
